...
const fhNote = FH.affiliate ? `Annoncelink. <a href="/annoncelinks/">Sådan tjener siden penge</a>.` : `Almindeligt link. Vi har ingen aftale med Flyhjælp endnu; <a href="/annoncelinks/">læs mere</a>.`;
function ctaBox({ h, p, btn = 'Start din sag hos Flyhjælp' } = {}) {
  return `<aside class="cta"><div><h2>${esc(h || 'Vil du have hjælp til at kræve pengene?')}</h2><p>${p || 'Flyhjælp er et dansk selskab, der tager sagen mod flyselskabet for dig. De tager 30 % af kompensationen inkl. moms, og kun hvis du får pengene. Får du ingen kompensation, koster det ikke noget. Det tager et par minutter at oprette sagen.'}</p></div><div class="cta-actions"><a class="btn big" href="${esc(FH.url)}" target="_blank" rel="${fhRel}">${esc(btn)}</a><span class="small muted">${fhNote}</span><a class="btn secondary" href="/klag-selv/">Eller klag selv, gratis</a></div></aside>`;
}
const ctaJson = JSON.stringify({ h: 'Vil du have hjælp til at kræve pengene?', p: 'Flyhjælp er et dansk selskab, der tager sagen mod flyselskabet for dig. De tager 30 % af kompensationen inkl. moms, og kun hvis du får pengene. Får du ingen kompensation, koster det ikke noget.', url: FH.url, rel: fhRel, btn: 'Start din sag hos Flyhjælp', note: fhNote });
...
const FAQ_GENERAL = [
  ...
  { q: 'Hvad hvis flyselskabet siger, det var vejret?', a: 'Vejr, der reelt umuliggør flyvningen, er en usædvanlig omstændighed, som fritager selskabet for kompensation. Men det skal være vejret ved netop din flyvning, og selskabet skal kunne dokumentere det. Bed om dokumentationen. Du har uanset ret til forplejning, ombookning eller refusion.' },
];
const FAQ_RULES = [
  ...
  { q: 'Er strejke en usædvanlig omstændighed?', a: 'Det afhænger af, hvem der strejker. Strejker flyselskabets eget personale, piloter eller kabinepersonale, er det ifølge EU-Domstolen (Airhelp mod SAS, 2021) en del af selskabets normale drift, og du har krav på kompensation. Strejker flyveledere, lufthavnspersonale eller sikkerhedskontrollen, er det uden for selskabets kontrol, og kompensationen bortfalder.' },
...
<h2>Selskabets undtagelser</h2><p>Aflysninger på grund af vejr, flyvelederstrejke, lukket luftrum eller sikkerhed giver ikke kompensation. Aflysninger på grund af teknik, besætning, egen strejke, for få passagerer eller "operationelle årsager" gør. <a href="/regler/">Se hele listen</a>.</p>`,
    faq: [
...
<h2>Dine rettigheder</h2><ul><li>Kompensation på 250, 400 eller 600 € <strong>med det samme</strong>, i lufthavnen eller senest inden 7 dage.</li><li>Valget mellem refusion og ombookning til din destination.</li><li>Forplejning, og hotel hvis ombookningen først er næste dag.</li><li>Ombookes du til en lavere klasse, skal 30 til 75 % af billetprisen refunderes oven i.</li></ul>
<h2>Sørg for dokumentation</h2><p>Bed om en skriftlig bekræftelse på, at du blev nægtet boarding, og på årsagen. Selskabet er forpligtet til at udlevere en skriftlig meddelelse om dine rettigheder. Fotografér boardingkort og opslag ved gaten.</p>`,
    faq: [
      ...
      { q: 'Jeg blev nægtet boarding på hjemrejsen, fordi udrejsen var aflyst. Gælder det?', a: 'Ja. Annullerer selskabet din hjemrejse, fordi du ikke brugte udrejsen, og afviser dig ved gaten, er det nægtet boarding (sag C-321/11, 2012). Du har krav på kompensation.' },
...
<h2>Det, du skal holde øje med</h2><ul><li><strong>Hvem strejker?</strong> Selskaberne skriver ofte bare "strejke". Spørg, om det var deres eget personale.</li><li><strong>14-dages-reglen.</strong> Aflyser selskabet fly mere end 14 dage før en varslet strejke, bortfalder kompensationen, men ikke retten til refusion.</li><li><strong>Personale hos et datterselskab.</strong> Strejker piloter i et datterselskab, der flyver for hovedselskabet, gælder det som egen strejke.</li><li><strong>Kompensationsselskaberne siger ofte nej til strejkesager</strong>, fordi de er sværere at vinde og betales dårligere. Det betyder ikke, at du ikke har et krav. Overvej at <a href="/klag-selv/">klage selv</a>.</li></ul>`,
    faq: [
      ...
      { q: 'Flyveledere i Frankrig strejkede, og mit fly til Malaga blev aflyst. Får jeg kompensation?', a: 'Nej. Flyvelederstrejke er uden for selskabets kontrol og en usædvanlig omstændighed. Du har ret til at vælge mellem refusion og ombookning og til forplejning og hotel, mens du venter.' },
  ...
  bagage: { name: 'Forsinket eller mistet bagage', short: 'bagage', seo: 'Forsinket eller mistet bagage: dine rettigheder', title: 'Forsinket, beskadiget eller mistet bagage: dine rettigheder og frister',
    answer: 'Bagage er ikke omfattet af EU-forordning 261/2004, men af <strong>Montreal-konventionen</strong>. Selskabet hæfter for op til <strong>1.288 SDR</strong>, cirka 11.000 kr, pr. passager for forsinket, beskadiget eller mistet bagage. Du skal anmelde skader <strong>inden 7 dage</strong> og forsinkelse <strong>inden 21 dage</strong> skriftligt, ellers mister du kravet. Bagage regnes som mistet efter 21 dage.',
...
<tr><td>Beskadiget kuffert eller indhold</td><td>7 dage fra modtagelsen</td><td>Reparation eller erstatning af kuffert og indhold, op til 1.288 SDR.</td></tr>
...
<tr><td>Mistet bagage (efter 21 dage)</td><td>2 år for at anlægge sag</td><td>Erstatning for kuffert og indhold, op til 1.288 SDR. Du skal kunne sandsynliggøre indholdets værdi.</td></tr></tbody></table></div>
<p>SDR er en regningsenhed fra Den Internationale Valutafond. 1.288 SDR svarer til omkring 11.000 kr; beløbet svinger med kursen.</p>
<h2>Forsikringen først</h2><p>Mange rejse- og indboforsikringer dækker bagage bedre og hurtigere end flyselskabet, og uden loftet på 1.288 SDR for dyre ting. Anmeld til begge, men få pengene ét sted. Betalte du rejsen med kreditkort, kan kortets rejseforsikring også dække.</p>
...
for (const [key, s] of Object.entries(SITUATIONS)) {
  const cta = key === 'bagage' ? '' : key === 'strejke' ? ctaBox({ h: 'Var det selskabets egen strejke?', p: 'Så har du et krav som ved enhver anden aflysning, og du kan lade Flyhjælp tage sagen mod 30 % af beløbet, kun hvis de vinder. Var det flyveledere eller lufthavnen, der strejkede, er der ingen kompensation at hente, og du skal i stedet sikre dig refusion eller ombookning direkte hos selskabet.' }) : ctaBox();
...
for (const al of airlines) {
  ...
  await emit({ path: `/flyselskab/${al.slug}/`, title: `${al.name}: kompensation for forsinket eller aflyst fly | Tjek dit fly`, description: `Sådan får du kompensation hos ${al.name}: beløb, om hjemrejser er dækket, hvor du klager, og hvad der er særligt for ${al.name}.`,
    ...
    extra: [{ '@type': 'Airline', name: al.name, legalName: al.legal, url: al.site, iataCode: undefined }],
...
${ctaBox({ h: `Lad Flyhjælp tage sagen mod ${al.name}`, p: `Flyhjælp fører sager mod ${al.name} og de andre selskaber, der flyver fra Danmark. De tager 30 % af kompensationen inkl. moms, og kun hvis du får pengene. Får du ingen kompensation, koster det ikke noget.` })}
...
${k === 'strejke' ? ctaBox({ h: `Var det ${al.name}s egen strejke?`, p: `Så har du et krav som ved enhver anden aflysning, og Flyhjælp kan tage sagen mod 30 % af beløbet, kun hvis de vinder. Var det flyveledere eller lufthavnen, der strejkede, er der ingen kompensation at hente.` }) : ctaBox({ h: `Lad Flyhjælp tage sagen mod ${al.name}`, p: `Flyhjælp fører sager om ${s.short} mod ${al.name} og de andre selskaber, der flyver fra Danmark. De tager 30 % af kompensationen inkl. moms, og kun hvis du får pengene.` })}
...
for (const r of routeList) {
  const { from, to } = r;
  const back = to.zone === 'eu' ? `Hjemrejsen fra ${to.city} til ${from.city} er dækket på samme måde, fordi ${to.country === 'Danmark' ? 'begge lufthavne ligger i Danmark' : `${to.country} ${['Norge', 'Island', 'Schweiz'].includes(to.country) ? 'er omfattet af EU-reglerne gennem EØS-aftalen' : 'er et EU-land'}`}. Beløbet er det samme, ${r.eur} €.`
  ...
  const examples = r.eur === 250 ? 'En forsinkelse på 3 timer giver det fulde beløb; ombookes du ved aflysning og når frem højst 2 timer senere end planlagt, må selskabet halvere til 125 €.'
    : r.eur === 400 ? 'Ombookes du ved aflysning og når frem højst 3 timer senere end planlagt, må selskabet halvere til 200 €.'
      : 'Er forsinkelsen mellem 3 og 4 timer, må selskabet halvere til 300 €. Fra 4 timer er det fulde beløb 600 €.';
  const faq = [
...
${ctaBox({ h: `Forsinket eller aflyst mellem ${from.city} og ${to.city}?`, p: `Flyhjælp tager sagen mod flyselskabet for dig. De tager 30 % af de ${r.eur} € inkl. moms, og kun hvis du får pengene. Får du ingen kompensation, koster det ikke noget.` })}
...
- Usædvanlige omstændigheder (fritager): vejr ved den konkrete flyvning, flyveleder- og lufthavnsstrejke, fugle, lukket luftrum, sikkerhed. Fritager ikke: tekniske fejl, manglende besætning, egen strejke (Airhelp mod SAS, C-28/20), forsinket indkommende fly.
